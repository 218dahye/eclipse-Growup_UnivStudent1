...
class init {
	...
	static void N_Lecture_power() {
		JOptionPane.showMessageDialog(null, "e편의점에 가서 군것질을 하느라 만원을 썼어!", "군것질", JOptionPane.INFORMATION_MESSAGE);
		int random = (int) (Math.random() * 20 + 1);
		if (random >= 17) {
			Intelli += 20;
	...
	static void H_Lecture_power() {
		JOptionPane.showMessageDialog(null, "e편의점에 가서 군것질을 하느라 2만원을 썼어!", "군것질", JOptionPane.INFORMATION_MESSAGE);
		int random = (int) (Math.random() * 20 + 1);
		if (random >= 17) {
			Intelli += 20;
